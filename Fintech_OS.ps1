...
Invoke-WebRequest -Uri "https://ftosautodeploystorage.blob.core.windows.net/kits/FTOS-CORE-RLS-v18.1.13.0-b411-GOLD.zip" -OutFile "C:\Kits\FintechOS\FTOS-CORE.zip"
