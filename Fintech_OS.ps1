...
Invoke-WebRequest -Uri "https://ftosautodeploystorage.blob.core.windows.net/kits/FTOS-CORE-RLS-v18.1.12.0-b396-GOLD.zip" -OutFile "C:\Kits\FintechOS\FTOS-CORE.zip"
