...
Invoke-WebRequest -Uri "https://ftosautodeploystorage.blob.core.windows.net/kits/FTOS-CORE-RLS-v18.1.14.0-b419-GOLD.zip" -OutFile "C:\Kits\FintechOS\FTOS-CORE.zip"
